...
_0x0:
	...
	.DB  0x4E,0x49,0x43,0x2E,0x43,0x4F,0x4D,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0032 DDRD=0x00;
	OUT  0x11,R30
; 0000 0033 
; 0000 0034 // Alphanumeric LCD initialization
; 0000 0035 // Connections are specified in the
; 0000 0036 // Project|Configure|C Compiler|Libraries|Alphanumeric LCD menu:
; 0000 0037 // RS - PORTD Bit 0
; 0000 0038 // RD - PORTD Bit 1
; 0000 0039 // EN - PORTD Bit 2
; 0000 003A // D4 - PORTD Bit 4
; 0000 003B // D5 - PORTD Bit 5
; 0000 003C // D6 - PORTD Bit 6
; 0000 003D // D7 - PORTD Bit 7
; 0000 003E // Characters/line: 16
...
; 0000 0043 lcd_gotoxy(0,0);
	...
	RCALL _lcd_gotoxy
; 0000 0044 
; 0000 0045 lcd_putsf("WWW.NAMINIC.COM");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 0046 
; 0000 0047 while (1)
